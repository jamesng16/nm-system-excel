...
- **Clean Architecture cấp độ Module**: Cấu trúc mã nguồn frontend phân tách độc lập theo từng tính năng, mỗi module sở hữu các lớp riêng biệt: `domain`, `usecases`, `adapters`, `presentation`. (Validated in Phase 1: Local Supabase & DB Migrations - 2026-05-20)
- **Môi trường phát triển cục bộ**: Thiết lập nhanh môi trường phát triển độc lập với Docker Compose chạy local Supabase, chạy khởi tạo database bằng các file SQL migrations thô. (Validated in Phase 1: Local Supabase & DB Migrations - 2026-05-20)
...
---
*Last updated: 2026-05-20 sau khi hoàn thành Phase 1*
