...
- [x] **INF-03**: Cấu trúc thư mục frontend React Vite + TSX theo mô hình Clean Architecture phân rã theo Module với các lớp tự chứa:
...
| INF-03 | Phase 1: Local Supabase & DB Migrations | Complete |
